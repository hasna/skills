...
```bash
excel --preset budget --rows 12 --output ./budget.xlsx
excel --prompt "Create a weekly content calendar" --output ./calendar.xlsx
excel --format csv --preset invoice --output ./invoice.csv
```
