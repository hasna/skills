...
function parseOptions(): SkillOptions {
  ...
  if (values.help) {
    console.log(`
action-item-router - Route action items to target systems

Usage:
  bun run skills/action-item-router/src/index.ts [options] [file]
...
Examples:
  bun run skills/action-item-router/src/index.ts items.txt
  bun run skills/action-item-router/src/index.ts --text "Review Q4 budget"
`);
    process.exit(0);
  }
