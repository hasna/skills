...
const SERVICE_NAME = "service-domainsearch";
...
\`${SERVICE_NAME}\` is a domain search service that provides:
...
\`\`\`bash
# Search for a domain
service-domainsearch search --query "example"

# Check domain availability
service-domainsearch check --domain "example.com"

# Get suggestions
service-domainsearch suggest --keyword "tech"

# Start the server
service-domainsearch server
\`\`\`
