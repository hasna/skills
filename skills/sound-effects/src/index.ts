...
const SKILL_META = {
  ...
  version: '1.0.0',
  commands: `Use: sound-effects --help`,
...
USAGE:
  sound-effects generate [OPTIONS]
...
EXAMPLES:
  sound-effects generate --prompt "thunder rolling" --output ./thunder.mp3
  sound-effects generate --prompt "footsteps on gravel" --duration 5 --output ./steps.mp3
  sound-effects generate --prompt "rain on a tin roof" --output ./rain.mp3
