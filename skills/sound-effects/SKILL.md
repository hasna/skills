...
```bash
sound-effects generate --prompt "thunder rolling in the distance" --output ./thunder.mp3
sound-effects generate --prompt "footsteps on gravel" --duration 5 --output ./steps.mp3
sound-effects generate --prompt "spaceship engine humming" --output ./engine.mp3
```
