...
\`\`\`bash
# Basic usage
deepresearch "What are the best practices for building RAG systems?"

# Quick research (6 queries)
deepresearch "What is vector search?" --depth quick

# Normal research (15 queries, default)
deepresearch "Best practices for ML systems" --depth normal

# Deep research (30 queries, 2 iterations)
deepresearch "Compare React vs Vue" --depth deep

# Use OpenAI instead of Claude
deepresearch "State of AI in 2024" --model openai

# Custom output location
deepresearch "Kubernetes best practices" --output ./k8s-research.md

# Include raw sources JSON
deepresearch "GraphQL vs REST APIs" --json
\`\`\`
...
- Bun runtime with \`deepresearch\` installed globally

## Install CLI

\`\`\`bash
bun add -g @hasnaxyz/deepresearch
\`\`\`
`;
