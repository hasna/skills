...
/**
 * implementation - Project implementation scaffold generator
 *
...
function printHelp() {
  console.log(`implementation - Project implementation scaffold generator
...
EXAMPLES:
  implementation              Create scaffold in current directory
  implementation --force      Recreate existing scaffold
`);
}
