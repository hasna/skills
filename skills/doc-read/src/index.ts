...
Examples:
  doc-read read document.docx
  doc-read read *.docx --format json --output extracted.json
  doc-read read report.docx --format markdown
  doc-read info document.docx
`);
    process.exit(0);
  }
