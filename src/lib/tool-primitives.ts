...
export const TOOL_PRIMITIVES: ToolPrimitive[] = [
  {
    ...
    title: "AI Gateway",
    family: "ai",
    description: "Hosted text, code, reasoning, and multimodal AI calls through the configured gateway.",
    runtime: "gateway",
    stable: true,
  ...
  },
  {
    ...
    family: "connectors",
    description: "Declare and execute external account operations through approved connector plans instead of direct service-specific CLIs.",
    runtime: "connector",
    stable: true,
    cliCommands: ["skills tools deps <skill>", "skills run <skill>"],
    mcpTools: ["get_skill_tool_dependencies", "run_skill"],
  ...
  },
  {
    ...
    title: "Hosted Auth",
    family: "hosted",
    description: "Authenticate hosted and premium runs through Skills account credentials rather than local service keys.",
    runtime: "hosted",
    stable: true,
